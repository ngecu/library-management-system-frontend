  ...
  return (
    <div className="container-fluid">
      ...
      <div className="export-buttons">
        <Button onClick={() => generatePDF(transactions)} style={{ marginRight: 8 }}>
          <FaPrint /> Export to PDF
        </Button>
        <Button onClick={() => generateCSV(transactions)}>
          <IoCloudDownloadSharp /> Export to CSV
        </Button>
      </div>
